...
if (!function_exists('render_heading')) {
...
if (is_array($titles)) {
    foreach ($titles as $single_title) {
        switch($font_size) {
            case 'h1':
                ...
                render_heading('h1', $preview, $single_title);
                break;
            case 'h2':
                $preview = get_field('preview_h2', 'option');
                render_heading('h2', $preview, $single_title);
                break;
            case 'h3':
                $preview = get_field('preview_h3', 'option');
                render_heading('h3', $preview, $single_title);
                break;
            case 'h4':
                $preview = get_field('preview_h4', 'option');
                render_heading('h4', $preview, $single_title);
                break;
            case 'h5':
                $preview = get_field('preview_h5', 'option');
                render_heading('h5', $preview, $single_title);
                break;
            case 'h6':
                $preview = get_field('preview_h6', 'option');
                render_heading('h6', $preview, $single_title);
                break;
            default:
                ?>
    ...
    switch($font_size) {
        case 'h1':
            $preview = get_field('preview_h1', 'option');
            render_heading('h1', $preview, $titles);
            break;
        case 'h2':
            $preview = get_field('preview_h2', 'option');
            render_heading('h2', $preview, $titles);
            break;
        case 'h3':
            $preview = get_field('preview_h3', 'option');
            render_heading('h3', $preview, $titles);
            break;
        case 'h4':
            $preview = get_field('preview_h4', 'option');
            render_heading('h4', $preview, $titles);
            break;
        case 'h5':
            $preview = get_field('preview_h5', 'option');
            render_heading('h5', $preview, $titles);
            break;
        case 'h6':
            $preview = get_field('preview_h6', 'option');
            render_heading('h6', $preview, $titles);
            break;
        default:
            ?>
            <<?php echo esc_html($font_size); ?> class="<?php echo esc_attr($classes_str); ?>">
